...
export class LLM {
    ...
    async load(model, options) {
        ...
        const use_externaldata = true;
        const hasFP16 = (provider === "wasm") ? false : options.hasFP16;
        this.profiler = options.profiler;

        // const model_path = (local) ? "models/" + model : "https://huggingface.co/" + model + "/resolve/main";
        const model_path = model;
        const model_file = (hasFP16) ? "model_q4f16.onnx" : "model_q4.onnx";
        log(`loading... ${model_path},  ${provider}`);
